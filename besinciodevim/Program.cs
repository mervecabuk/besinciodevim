...
/*
odev: //1-10 arasında çarpım tablosunu yazdıran bir method tasarlayınız.

void CarpimTablosunuYazdir() {
  ...
  for(int ilkRakam = 1; ilkRakam < 10; ilkRakam++) {
    for(int ikinciRakam = 1; ikinciRakam < 10; ikinciRakam++){
      Console.WriteLine(ilkRakam + " x " + ikinciRakam + " = " + (ilkRakam*ikinciRakam));
    }
  }
}
